        ...
        <div>
            ...
            <Container className="mt-4">
                {loading ? (
                    ...
                    <Row>
                        {id !== undefined ? ( // Render individual biography if :id is present
                            <Col sm={12}>
                                <Card>
                                    <Card.Img variant="top" src={space} className="img-fluid" style={{ maxHeight: '300px', objectFit: 'cover' }} />
                                    <Card.Body>
                                        <Card.Title>{people[id]?.name}</Card.Title> {/* Optional chaining to avoid errors if id is out of bounds */}
                                        <Card.Text>
